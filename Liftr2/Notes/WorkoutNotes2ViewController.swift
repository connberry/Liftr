...
class WorkoutNotes2ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    @IBAction func inputButton(_ sender: Any) {
        ...
        if exerView.text != "" {
            ...
            ref?.child("user").child(Auth.auth().currentUser!.uid).child("workout notes").child("notes 2").childByAutoId().setValue(dict)
            exerView.text = ""
